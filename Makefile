...
clean: ## Remove every generated cache and build artifact
	# Everything here is regenerated by `make check`; nothing here is tracked.
	# The list mirrors the generated-file section of .gitignore.
	rm -rf build dist *.egg-info .eggs
	rm -rf .pytest_cache .ruff_cache .mypy_cache .dmypy.json .tox .nox
