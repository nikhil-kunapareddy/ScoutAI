...
from ..tools.jobs import amazon, ashby, google, greenhouse, lenovo, netflix
...
SYSTEM_PROMPT = (
    ...
    "approximate location, and recent job openings at Amazon, Google, Netflix, "
    "Lenovo, Greenhouse-hosted companies (Databricks, Airbnb, Stripe, Pinterest, "
    "Reddit, Coinbase, Dropbox, Robinhood — pass the company name to "
    "search_greenhouse_jobs), and Ashby-hosted companies (WHOOP — pass the company "
    "name to search_ashby_jobs). "
...
SPEC = AgentSpec(
    ...
    tool_modules=[clock, location, referrals_read, amazon, google, netflix, lenovo,
                  greenhouse, ashby],
