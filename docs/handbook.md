# Scout — engineering handbook

The working reference: Slack setup, deployment, configuration, and how to
extend it. For the short version, see the [README](../README.md).
